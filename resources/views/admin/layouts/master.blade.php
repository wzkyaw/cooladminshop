            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#contactListPage') }}" class=" text-decoration-none">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer" style="padding:12px 0px ;">
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <div class="account-dropdown__item" style="">
                                                        <button type="submit" class="logout btn text-left w-100" style="padding:15px 25px;">
