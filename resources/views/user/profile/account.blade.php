                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <a href="{{ route('user#home') }}" class="text-white btn btn-dark">
                                    ...
                                    <div class="col-4 offset-1">
                                        ...
                                        @if (Auth::user()->image == null)
                                            @if (Auth::user()->gender == 'male')
                                                <img src="{{ asset('image/default_user_profile.jpg') }}" class="img-thumbnail w-100">
                                            @else
                                                <img src="{{ asset('image/female_default.png') }}" class="img-thumbnail w-100">
                                            @endif
                                        @else
                                            <img src="{{ asset('storage/'.Auth::user()->image) }}" class="img-thumbnail w-100" />
                                        @endif
